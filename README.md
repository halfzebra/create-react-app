# react-observatory-scripts

Create [React Observatory](https://github.com/halfzebra/react-observatory) apps with no build configuration.
...
create-react-app my-app --scripts-version=react-observatory-scripts
cd my-app/
npm start
```
